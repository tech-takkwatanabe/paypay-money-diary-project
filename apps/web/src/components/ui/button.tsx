...
function Button({ variant = "default", ...props }: ButtonProps) {
  switch (variant) {
    case "destructive": return <ButtonDestructive {...props} />
    case "outline": return <ButtonOutline {...props} />
    case "secondary": return <ButtonSecondary {...props} />
    case "ghost": return <ButtonGhost {...props} />
    case "link": return <ButtonLink {...props} />
    default: return <ButtonDefault {...props} />
  }
}
