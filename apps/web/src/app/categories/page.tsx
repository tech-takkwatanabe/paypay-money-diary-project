...
export default function CategoriesPage() {
	...
	const [formData, setFormData] = useState<CategoryFormData>({ name: '', color: '#ef4444', icon: '' });
									...
									<div key={category.id} className="py-4">
										{editingId === category.id ? (
											<div className="space-y-4">
												...
												{error && <p className="text-sm text-red-500">{error}</p>}
												<div className="flex gap-2">
													<button onClick={() => handleUpdate(category.id)} disabled={isSubmitting} className="p-2 text-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg">
											...
											<div className="flex items-center justify-between">
												...
												<div className="flex gap-1">
													<button onClick={() => startEdit(category)} className="p-2 text-gray-500 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors">
