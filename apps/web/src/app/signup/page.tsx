...
import { postAuthSignup } from '@/api/generated/認証/認証';
		...
		<div className="min-h-screen flex">
			...
			<div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-900">
				<div className="w-full max-w-md">
					...
					<p className="mt-6 text-center text-xs text-gray-400">登録することで、利用規約とプライバシーポリシーに同意したものとみなされます。</p>
				</div>
			</div>

			{/* 右側：ブランドエリア */}
			<div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-pink-600 via-red-500 to-orange-500 relative overflow-hidden">
				{/* 装飾的な背景要素 */}
