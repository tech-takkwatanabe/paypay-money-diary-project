...
export type postTransactionsUploadResponse = (postTransactionsUploadResponseSuccess | postTransactionsUploadResponseError)
...
export const postTransactionsUpload = async (postTransactionsUploadBody: PostTransactionsUploadBody, options?: RequestInit): Promise<postTransactionsUploadResponse> => {
...
export const getTransactionsSummary = async (params: GetTransactionsSummaryParams, options?: RequestInit): Promise<getTransactionsSummaryResponse> => {
...
export const getTransactionsAvailableYears = async ( options?: RequestInit): Promise<getTransactionsAvailableYearsResponse> => {
...
export const postTransactionsReCategorize = async (reCategorizeInput: ReCategorizeInput, options?: RequestInit): Promise<postTransactionsReCategorizeResponse> => {
...
export const putTransactionsId = async (id: string,
    updateTransactionInput: UpdateTransactionInput, options?: RequestInit): Promise<putTransactionsIdResponse> => {
...
export const deleteTransactionsId = async (id: string, options?: RequestInit): Promise<deleteTransactionsIdResponse> => {
