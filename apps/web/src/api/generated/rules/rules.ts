...
export const postRules = async (createRuleInput: CreateRuleInput, options?: RequestInit): Promise<postRulesResponse> => {
...
export type putRulesIdResponseError = (putRulesIdResponse400 | putRulesIdResponse401 | putRulesIdResponse403 | putRulesIdResponse404 | putRulesIdResponse500) & {
  headers: Headers;
};
...
export const putRulesId = async (id: string,
    updateRuleInput: UpdateRuleInput, options?: RequestInit): Promise<putRulesIdResponse> => {
...
export type deleteRulesIdResponseError = (deleteRulesIdResponse401 | deleteRulesIdResponse403 | deleteRulesIdResponse404 | deleteRulesIdResponse500) & {
  headers: Headers;
};
