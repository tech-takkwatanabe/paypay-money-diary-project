...
- [x] **Phase 5: 追加機能 & 改善**
  - [x] 5.1 カテゴリルール管理
    ...
    - [x] ルール管理 UI
    - [x] expenseの再カテゴリ分類機能
  - [x] Phase 5.2: 予算管理機能の実装 (削除済み)
  - [x] トークンリフレッシュの競合（Race Condition）の修正

- [x] **Phase 7: 支出一覧機能の実装**
  - [x] 7.1 バックエンド API 拡張
    - [x] GET /api/transactions の検索・ソート対応
    - [x] PATCH /api/transactions/:id (カテゴリ更新) API 実装
  ...
  - [x] 7.2 支出一覧ページ作成
    ...
    - [x] 検索機能 (merchant) 実装
    - [x] ソート機能実装
    - [x] カテゴリ編集機能 (一個ずつカテゴリーを変更できる機能) 実装
